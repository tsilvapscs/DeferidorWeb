...
namespace RCPJ.BLL
{
    ...
    public class bBoleto
    {
        ...
        public void AddBoleto(Boleto lBoleto)
        {
			...
			_Buffer.Append("<tr><TD class=ld align=center><spam id=NossoNumero1>"  + lBoleto.Carteira +"/"+ lNossoNumero + "</Label></TD></tr></table></TD>");
            ...
            */
            ...
            _Buffer.Append("<tr><td class=ct>&nbsp;Vencimento</td></tr>");
            _Buffer.Append("<tr><td class=ld align=right><spam id=dtavencto2>" + lBoleto.DtVencimento.ToString(Boleto.DATEFORMAT) + "</spam></td></tr></table></TD></TR>");
            _Buffer.Append("<TR><TD vAlign=top colSpan=5><table cellSpacing=0 cellPadding=0 width=\"100%\" border=0>");
            _Buffer.Append("<tr><td class=ct>&nbsp;Cedente</td></tr>");
            ...
            _Buffer.Append("<tr><td class=ld align=right><Spam id=CodCedente2 >" + lBoleto.AgenciaCedente() + "</spam></td></tr></table></TD></TR>");
            _Buffer.Append("<TR><TD vAlign=top><table cellSpacing=0 cellPadding=0 width=\"100%\" border=0>");
            ...
            _Buffer.Append("<tr><td class=ld align=center><spam id=aceite2>&nbsp;N&nbsp;</spam></td></tr></table></TD>");
            _Buffer.Append("<TD vAlign=top><table cellSpacing=0 cellPadding=0 width=\"100%\" border=0>");
            ...
            _Buffer.Append("<TD vAlign=top width=140><table cellSpacing=0 cellPadding=0 width=\"100%\" border=0>");
            _Buffer.Append("<tr><td class=ct>&nbsp;Nosso Número</td></tr>");
            _Buffer.Append("<tr><td class=ld align=right><spam id=nossonumero12>" + lBoleto.Carteira + "/" + lNossoNumero + "</spam></td></tr></table></TD></TR>");
            _Buffer.Append("<TR><TD vAlign=top><table cellSpacing=0 cellPadding=0 width=\"100%\" border=0>");
            ...
            _Buffer.Append("<TD vAlign=top width=140 bgColor=#cccccc><table cellSpacing=0 cellPadding=0 width=\"100%\" border=0>");
            _Buffer.Append("<tr><td class=ct colSpan=2>&nbsp;(=) Valor do Documento</td></tr>");
            _Buffer.Append("<tr><td class=ld width=30 align=right>&nbsp;</td><td class=ld align=right><spam id=valordocumento2 >" + lBoleto.Valor.ToString(Boleto.VALORFORMAT) + "</spam>&nbsp;</td></tr></table></TD></TR>");
            ...
            _Buffer.Append("<td class=ld><spam id=nossonumero22>" + lBoleto.Carteira + "/" + lNossoNumero + "</spam></td></tr><tr>");
            ...
            _Buffer.Append("<tr><td class=ct>&nbsp;Vencimento</td></tr><tr><td class=ld align=right>&nbsp;<spam id=dtavencto3>" + lBoleto.DtVencimento.ToString(Boleto.DATEFORMAT) + "</spam>");
            ...
            _Buffer.Append("<td class=ld align=right>&nbsp;<aps:label id=codigocedente3>" + lBoleto.AgenciaCedente() + "</spam></td></tr></table></TD></TR>");
            _Buffer.Append("<TR><TD vAlign=top><table cellSpacing=0 cellPadding=0 width=\"100%\" border=0>");
            ...
            _Buffer.Append("<tr><td class=ld align=center CssClass=\"ld\">&nbsp;<spam id=aceite3>&nbsp;N&nbsp;</spam></td></tr></table></TD>");
            ...
            _Buffer.Append("<td class=ld align=right>&nbsp;<spam id=nossonumero13>" + lBoleto.Carteira + "/" + lNossoNumero + "</spam></td></tr></table></TD></TR>");
            _Buffer.Append("<TR><TD vAlign=top><table cellSpacing=0 cellPadding=0 width=\"100%\" border=0>");
            ...
            _Buffer.Append("<td class=ct>&nbsp;(=) Valor do Documento</td></tr><tr><td class=ld align=right>&nbsp;<spam id=valordocumento3>" + lBoleto.Valor.ToString(Boleto.VALORFORMAT) + "</spam></td></tr></table></TD></TR>");
            _Buffer.Append("<TR><td vAlign=top colSpan=5 rowSpan=5><table cellSpacing=0 cellPadding=0 width=\"100%\" border=0>");
            _Buffer.Append("<tr><td class=ct>&nbsp;Instruções&nbsp;(Todas as informações deste bloqueto são de exclusiva responsabilidade do cedente)</td></tr><tr><td class=ld>&nbsp;<spam id=instrucao13>" + lBoleto.Instrucao1 + "</spam></td></tr>");
            ...
            _Buffer.Append("<td class=ld><spam id=nossonumero23  >" + lBoleto.Carteira + "/" + lNossoNumero + "</spam></td></tr><tr>");
            ...
            _Buffer.Append("<td class=ct vAlign=top align=center width=300>&nbsp;Autenticação Mecânica&nbsp;/&nbsp;Ficha de Compensação&nbsp;</td></tr><tr>");
            _Buffer.Append("<td><spam id=CodBarras>" + Codiodebarras + "</spam></td>");
            _Buffer.Append("<td class=cp vAlign=bottom align=right></td></tr></table>");
            //_Buffer.Append("<div align=center><img src=" + sImgCorte + "></div>");
        }
    ...
    public abstract class Boleto
    {
        ...
        protected string _LocalPagamento = "ATÉ O VENCIMENTO, PREFERENCIALMENTE NO ITAÚ. APÓS O VENCIMENTO, SOMENTE NO ITAÚ";
    ...
    public class BoletoItau : Boleto
    {
        ...
        public override void MontaCodigos(out string lNossoNumero, out string lLinhaDigitavel, out string lCodigoBarras)
        {
            ...
            //sDac = "0057" + "72192" + "198" + lNossoNumero;

            string lNossoNumeroAux = lNossoNumero;

            //lNossoNumero = "0057" + "72192" + "198" + lNossoNumero;

            //lNossoNumero += Mod_dig10(sDac);
            lNossoNumero += Mod_dig10(_CedenteAgencia + _CedenteConta + _Carteira + lNossoNumero);
            ...
            //sCampoLivre += Mod_dig10(_CedenteAgencia + _CedenteConta + _Carteira + lNossoNumeroAux);
            sCampoLivre += _CedenteAgencia.PadLeft(4, '0') + _CedenteConta.PadLeft(5, '0');
            sCampoLivre += Mod_dig10(_CedenteAgencia + _CedenteConta) + "000";

            sbarra = BancoCodigoFormatado() + "9" + sValor + sCampoLivre;

            //sbarra = "3419483800000036001758572190622938032634000";
            ...
            sCampo2 = lNossoNumero.Substring(2, 6) + Mod_dig10(_CedenteAgencia + _CedenteConta + _Carteira + lNossoNumeroAux);
            ...
            lLinhaDigitavel += sCampo3.Substring(0, 5) + "." + sCampo3.Substring(5, 6) + " ";
