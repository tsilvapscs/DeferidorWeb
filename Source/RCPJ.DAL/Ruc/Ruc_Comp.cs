...
{
    public class Ruc_Comp : DBInteractionBaseORACLE
    {
        // Variables ******************* 
        ...
        public void Update()
        {
            try
            {
                ...
                Sql.Append(" Values ");
                Sql.Append("  (");
                Sql.Append("	EvalDate(:v_rco_fec_const_nasc), ");
                Sql.Append("	:v_rco_num_reg_merc, ");
                Sql.Append("	EvalDate(:v_rco_fec_reg_merc), ");
                ...
                // Codigo dbParameter ******************* 
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_fec_const_nasc", OracleType.DateTime, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_fec_const_nasc));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_num_reg_merc", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_num_reg_merc));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_fec_reg_merc", OracleType.DateTime, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_fec_reg_merc));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_tge_ttip_doc", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_tge_ttip_doc));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_tge_vtip_doc", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_tge_vtip_doc));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_num_doc_ident", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_num_doc_ident));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_fec_emi_doc_id", OracleType.DateTime, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_fec_emi_doc_id));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_tnc_cod_natur", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_tnc_cod_natur));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_domic_pais", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_domic_pais));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_fec_incorp", OracleType.DateTime, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_fec_incorp));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_val_cap_soc", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_val_cap_soc));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_fec_rg_cap_soc", OracleType.DateTime, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_fec_rg_cap_soc));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_sexo", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_sexo));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_nume", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_nume));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_caja_po", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_caja_po));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_zona_caja_po", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_zona_caja_po));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_tge_tpais", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_tge_tpais));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_tge_vpais", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_tge_vpais));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_ruc_ext_uf", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_ruc_ext_uf));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_tus_cod_usr", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_tus_cod_usr));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_emis_doc_ident", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_emis_doc_ident));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_quad_lote", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_quad_lote));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_ident_comp", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_ident_comp));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_refer", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_refer));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_lic_mun", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_lic_mun));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_ttl_tip_logradoro", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_ttl_tip_logradoro));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_direccion", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_direccion));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_urbanizacion", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_urbanizacion));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_tes_cod_estado", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_tes_cod_estado));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_zona_postal", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_zona_postal));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_tge_tcier_bal", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_tge_tcier_bal));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_tge_vcier_bal", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_tge_vcier_bal));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_tge_treg_trib", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_tge_treg_trib));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_tge_vreg_trib", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_tge_vreg_trib));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_tmu_cod_mun", OracleType.Number, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_tmu_cod_mun));
                cmdToExecute.Parameters.Add(new OracleParameter("v_rco_rge_pra_protocolo", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_rge_pra_protocolo));
                //cmdToExecute.Parameters.Add(new OracleParameter("v_rco_num_reg_merc_sede", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rco_num_reg_merc_sede));
