    ...
    public class Ruc_General : DBInteractionBaseORACLE
    {
        ...
        public void Update()
        {
            try
            {
                ...
                cmdToExecute.Parameters.Add(new OracleParameter("v_rge_tus_cod_usr", OracleType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, "JUCESC"));
