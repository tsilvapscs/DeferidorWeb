...
var MONTH_NAMES=new Array('Janeiro','Fevereiro','Marco','Abril','Maio','Junho','Julho','Agosto','Setembro','Outubro','Novembro','Dezembro','Jan','Fev','Mar','Abr','Mai','Jun','Jul','Ago','Set','Out','Nov','Dez');
var DAY_NAMES=new Array('Domingo','Segunda','Terca','Quarta','Quinta','Sexta','Sabado','Dom','Seg','Ter','Qua','Qui','Sex','Sab');
...
function CalendarPopup() {
	...
	c.offsetY = 25;
	c.autoHide();
	c.monthNames = new Array('Janeiro','Fevereiro','Marco','Abril','Maio','Junho','Julho','Agosto','Setembro','Outubro','Novembro','Dezembro');
...
function CP_select(inputobj, linkname, format) {
   ...
   // alert('Esta carregando: ' + inputobj);
