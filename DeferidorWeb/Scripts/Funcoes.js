...
//Fechando tela transparente
   ...
   function VerificCPFCNPJAmbos(campo)
{
    var tipVerific
    var mens
    tiratudo(campo);
...
function janelaModal(url, nome, nrTamanho, nrLargura)
    {
        ...
        window.showModalDialog(url, nome,'Resizable:no;DialogHeight:'+nrTamanho+'px; DialogWidth:'+nrLargura+'px; Edge:raised; Help:no; Scroll:no, Status:no; Center:yes;');
